      ...
      (utils, { fns, data }) => {
        ...
        for (const pluginData of data.plugins) {
          pluginData.__mimeTypes.forEach((type, index) => {
            ...
            utils.cache.Object.defineProperty(plugins[pluginData.name], type, {
              value: mimeTypes[type],
              writable: false,
              enumerable: false, // Not enumerable
              configurable: true
            })
            utils.cache.Object.defineProperty(mimeTypes[type], 'enabledPlugin', {
              value:
        ...
        const patchNavigator = (name, value) =>
          utils.replaceProperty(utils.cache.Object.getPrototypeOf(navigator), name, {
            get() {
              return value
            }
          })
